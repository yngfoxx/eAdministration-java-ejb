    ...
    <body onload="init();">
      <div class="web-container" data-page="dashboard">
        <div class="top-bar" style="height: 38px;">
          ...
          <div class="tb-navigator">
            <div class="tb-nv-farRight">
              <a class="tb-nv-btn icon-bell-3" onclick="fetch_users_button();"></a>
        ...
        <div class="l-side-bar">
          <a class="l-side-bar-btn icon-monitor" onclick="navigate('labs');">
            <span class="lsbb_tooltip">Labs</span>
          </a>
          <a class="l-side-bar-btn icon-users lsbb_active_btn" onclick="navigate('users');">
        ...
        <div class="in-body">
          <div class="ib-labs-side">
            <div class="ibls-button" onclick="crt_user();">
            ...
            <div class="ib-labs-side-container">
              <%-- AJAX FETCH EXISTING USERS --%>
            </div>
          </div>

          <div class="ib-labs-body">
            <div class="fill-bg-msg">
              <a class="fill-msg">Click + Add Users to use extra administrative tools</a>
            </div>
          </div>
